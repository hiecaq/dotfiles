...
In inserting modes, enter transient god mode when =C-ESC= is typed. On my programmable keyboard that's the two split space bars typed together.
#+begin_src emacs-lisp :tangle no :noweb-ref god-mode-general
    (:states '(insert emacs) "C-<escape>" #'god-execute-with-current-bindings)
#+end_src
...
#+begin_src emacs-lisp
  (use-package embark
    ...
    :general
    (minibuffer-local-map "C-a"  'embark-act)
...
#+begin_src emacs-lisp
  (use-package flymake
    ...
    (defvar my/flymake-posframe--frame nil)

    (defun my/flymake-posframe--p ()
      (and (frame-live-p my/flymake-posframe--frame)
           (frame-visible-p my/flymake-posframe--frame)))

    (defun my/flymake-posframe-hide ()
      (posframe-hide my/flymake-posframe--buffer)
      (setq my/flymake-posframe--frame nil))
    ...
    (defun my/flymake-posframe-show ()
      ...
      (when-let* ((diags (flymake-diagnostics (point)))
        ...
        (with-current-buffer buffer
          (erase-buffer)
          (insert diags))
        (setq my/flymake-posframe--frame
