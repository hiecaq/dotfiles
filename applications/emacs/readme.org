...
- [[#ui-enhance][UI Enhance]]
  ...
  - [[#separedit][Separedit]]
  - [[#topsy][Topsy]]
  - [[#enforcing-display-buffer-rules][Enforcing display buffer rules]]
...
I switched to use Emacs' built-in facilities directly.
#+begin_src emacs-lisp
  (use-package shackle
    :straight t
    :custom
...
** Enforcing display buffer rules
see [[https://www.masteringemacs.org/article/demystifying-emacs-window-manager][Demystifying Emacs’s Window Manager]]
#+begin_src emacs-lisp
  (use-package window
    :custom
